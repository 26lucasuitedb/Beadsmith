// @module SuiteDB.SDBDownloadOrderCSV.SDBDownloadOrderCSV
define('SuiteDB.SDBDownloadOrderCSV.SDBDownloadOrderCSV.View'
	, [
		'suitedb_sdbdownloadordercsv_sdbdownloadordercsv.tpl'
		, 'Backbone'
	...
	, function (
		suitedb_sdbdownloadordercsv_sdbdownloadordercsv_tpl
		, Backbone
		, OrderDetailsView
		...
		// @class SuiteDB.SDBDownloadOrderCSV.SDBDownloadOrderCSV.View @extends Backbone.View
		return Backbone.View.extend({

			template: suitedb_sdbdownloadordercsv_sdbdownloadordercsv_tpl
			...
			, downloadOrderCSV: function downloadOrderCSV() {
				if (this.options.checkParent) {
					...
					var orderHistoryColumns = this.application.getConfig('transactionListColumns.enableOrderHistory') ? this.application.getConfig().transactionListColumns.orderHistory : "CSVDownloadOrderHelper.getDefaultColumns()" // Does this site use custom order history columns? If so, get them, otherwise provide some defaults
			...
			//@method getContext @return SuiteDB.SDBDownloadOrderCSV.SDBDownloadOrderCSV.View.Context
			, getContext: function getContext() {
				//@class SuiteDB.SDBDownloadOrderCSV.SDBDownloadOrderCSV.View.Context
