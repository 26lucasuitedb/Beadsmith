...
{{/if}}
  ...
  <div class="facets-item-cell-table-image-wrapper">
    ...
    <a class="facets-item-cell-table-link-image" href="{{url}}">
      {{#if itemChangesPLP}}
      <img
        class="facets-item-cell-table-image"
    ...
    {{#if isEnvironmentBrowser}}
      <div class="facets-item-cell-table-quick-view-wrapper">
        <a
          href="{{url}}"
          class="facets-item-cell-table-quick-view-link"
  ...
  <div class="facets-item-cell-table-content-wrapper">
    ...
    {{#if itemChangesPLP.isLoggedIn}}
      <div class="facets-item-cell-table-price">
        <table class="facets-item-cell-table-table">
          <tr class="facets-item-cell-table-table-row">
            <td class="facets-item-cell-table-table-cell">Min Qty</td>
            {{#each itemChangesPLP.prices}}
              <td
                class="facets-item-cell-table-table-cell"
              >{{minimumquantity}}+</td>
            {{/each}}
          </tr>
          <tr class="facets-item-cell-table-table-row">
    ...
    {{else}}
      <a
        class="header-profile-login-link-table"
