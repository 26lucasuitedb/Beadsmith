		...
		<div class="facets-facet-browse-results">
			...
			<div class="promotion-banner">
				<header class="promo-header">
					<p class="promotion-heading">{{promoName}}</p>
					<div class="promo-discount-rate">
						<p class="promotion-discount">{{promoDiscountRate}}</p>
						<p class="align-right">Coupon code: <span class="promotion-code">{{promoCode}}</span></p>
					</div>
				</header>
				<p class="promotion-content">{{promoDescription}}</p>

				<div class="promotion-apply-date">
					<p>{{#if promoStartDate}} Starts on: <span class="promotion-date">{{promoStartDate}}</span> {{/if}}
					</p>
					<p>{{#if promoEndDate}} Ends on: <span class="promotion-date">{{promoEndDate}}</span> {{/if}}</p>
				</div>

				<div class="note">
				{{#if autoapplied}}
					 <p>This promotion will be applied automatically on the Cart and Checkout pages.</p>
				{{/if}}
				{{#if canBeCombined}}
					 <p>This promotion can be combined with other promotions.</p>
					{{else}}
					<p>This promotion cannot be combined with other promotions.</p>
				{{/if}}
				</div>

			{{log this "promotionID: " promotionId}}
			</div>
			{{/if}}
			...
			<div data-view="SDBFacetCarouselView"></div>
