<li class="header-mini-cart-item-cell" data-item-id="{{itemId}}" data-item-type="{{itemType}}">
		...
		<div class="header-mini-cart-item-cell-details">
			<ul>
				...
				<li class="header-mini-cart-item-cell-sku" data-view="Item.Sku"> 		
		    ...
		    {{/if}}
		    	...
		    	<span class="header-mini-cart-item-cell-quantity-label">
					...
					<br>
				{{#if line.item.custitem_nsts_inventory_avail}}
					<span class="header-mini-cart-item-cell-quantity-label">Quantity Available: </span>
					<span class="header-mini-cart-item-cell-quantity-value">{{line.item.custitem_nsts_inventory_avail}}</span>
				{{else}}
					<span class="header-mini-cart-item-cell-quantity-label">Quantity Available: </span>
					<span class="header-mini-cart-item-cell-quantity-value">0</span>
				{{/if}}
			    </li>
		    </ul>
		</div>
