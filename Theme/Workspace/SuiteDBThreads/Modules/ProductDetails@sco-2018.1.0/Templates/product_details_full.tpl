                    ...
                    {{#if isItemProperlyConfigured}}
                        <form id="product-details-full-form" data-action="submit-form" method="POST">
                            ...
                            <div class="custom-pdp-fields-line-container">
                                ...
                                <span class="custom-pdp-fields-label">Quantity Available:
                                    {{model.item.custitem_nsts_inventory_avail}}</span>
                                {{else}}
                                <span class="custom-pdp-fields-label">Quantity Available: 0</span>
                                {{/if}}
                            </div>
