<tr class="transaction-line-views-cell-navigable {{cellClassName}} item-{{itemId}}" data-id="{{itemId}}"
	...
	<td class="transaction-line-views-cell-navigable-details" name="item-details">
		<p class="transaction-line-views-cell-navigable-product-name">
			{{#if isNavigable}}
			<a class="transaction-line-views-cell-navigable-product-title-anchor"
				{{{itemURLAttributes}}}>{{itemName}}</a>
			{{else}}
	...
	<td class="transaction-line-views-cell-navigable-item-quantity" name="item-avail-quantity">
		<p>
			{{#if model.item.custitem_nsts_inventory_avail}}
			<span class="transaction-line-views-cell-navigable-item-quantity-label">Quantity Available: </span>
			<span class="transaction-line-views-cell-navigable-item-quantity-value">{{model.item.custitem_nsts_inventory_avail}}</span>
			{{else}}
			<span class="transaction-line-views-cell-navigable-item-quantity-label">Quantity Available: </span>
			<span class="transaction-line-views-cell-navigable-item-quantity-value">0</span>
			{{/if}}
		</p>
