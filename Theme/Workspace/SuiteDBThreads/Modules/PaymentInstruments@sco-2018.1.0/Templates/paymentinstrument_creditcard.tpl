		...
		<div class="paymentinstrument-creditcard-container">
			...
			{{#if showActions}}
				<div class="paymentinstrument-creditcard-actions">
					...
					<a href="mailto:support@beadsmith.com?subject=Credit%20Card%20Removal%20Request" class="creditcard-edit-form-securitycode-icon-container">
						<span>
							<i class="creditcard-edit-form-securitycode-icon" data-trigger="hover" data-toggle="popover" data-placement="bottom" data-title="Credit Card Removal" data-content="To remove a payment method, please contact our sales team."></i>
						</span>
					</a>
				</div>
			{{/if}}
